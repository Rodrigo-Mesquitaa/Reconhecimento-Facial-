...
reconhecedor.read("classificadorEigenDeivi.yml")
#reconhecedor = cv2.face.FisherFaceRecognizer_create()
#reconhecedor.read("classificadorFisherDeivi.yml")
#reconhecedor = cv2.face.LBPHFaceRecognizer_create()
#reconhecedor.read("classificadorLBPHDeivi.yml")

totalAcertos = 0
percentualAcerto = 0.0
totalConfianca = 0.0

caminhos = [os.path.join('deivifaces/teste', f) for f in os.listdir('deivifaces/teste')]
